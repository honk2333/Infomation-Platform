...
<!-- 								<th>小计</th> -->
							...
							<c:forEach items="${mine.cartItems}" var="cartItem">
								<tr class="active">
				...
				<div style="margin-right:130px;">
					<div style="text-align:right;">
						<em style="color:#ff6600;">
							&nbsp;&nbsp;
						</em> 赠送积分: <em style="color:#ff6600;">${mine.total}</em>&nbsp; 酬金金额: <strong style="color:#ff6600;">￥${mine.total}元</strong>
					</div>
					<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
						<a href="${pageContext.request.contextPath}/product?method=clearCart" id="clear" class="clear">清空我发布的信息 </a>

                        <a href="${pageContext.request.contextPath}/product?method=submitOrder">
							<input  type="button" width="100" value="预付酬金" name="submit" border="0"
