...
<script type="text/javascript">
	$(document).ready(function () {
        $("#addCartItem").click(function () {
            ...
            //点击事件，为a赋值
			window.location.href="${pageContext.request.contextPath}/product?method=addCartItem&pid=${product.pid}&buyNum="+buyNum;
        });
    });
</script>
</head>
				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<%--给a标签一个点击事件--%>
							<a href="javascript:void(0);" id="addCartItem">
								<input style="background: url('./images/product.gif')
