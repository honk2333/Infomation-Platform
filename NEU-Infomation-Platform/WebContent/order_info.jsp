...
<body>
	...
	<div class="container">
			...
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						...
						<c:forEach items="${orders.getOrdersList()}" var="orderItem">
							<tr class="active">
		...
		<div>
			<hr />
			<%--表单--%>
			<form class="form-horizontal" id="confirmOrderForm"
				action="${pageContext.request.contextPath}/product" method="post"
				style="margin-top: 5px; margin-left: 150px;">
				<input type="hidden" name="method" value="confirmOrder"> <input
					type="hidden" name="oid" value="${orders.oid}"> <input
					type="hidden" name="total" value="${orders.total}">
				<div class="form-group">
					<label for="address" class="col-sm-1 control-label">地址</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="address"
							name="address" value="${orders.address}" placeholder="请输入收货地址">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="telephone"
							name="telephone" value="${orders.user.telephone}"
							placeholder="请输入联系方式">
					</div>
				</div>
				...
				<div style="margin-top: 5px; margin-left: 150px;">
					...
					<p style="text-align: right; margin-right: 100px;">
						<a href="javascript:void(0);" onclick="submitOrder()"> <img
